...
Engineered and delivered a LangGraph-based multi-agent research assistant for SME knowledge work, seamlessly combining planner, executor, reviewer, and human-in-the-loop approval stages. Integrated advanced RAG pipelines over internal knowledge and prior feedback lessons using Chroma, OpenAI embeddings, MMR retrieval, and Flashrank reranking. Incorporated robust tool access for web search, scraping, contact discovery, calculation, and internal memory retrieval, all secured with strict operational guardrails including API call limits, retries, summarisation, checkpointing, and recursion protection.
